<template>
  <header-section title="Asignación de trabajo" url-redirect="InboxWorkAssignation" :icon-image="iconModule">
  </header-section>
  <br>
  ...
  <div class="q-pa-md">
    ...
    >
      <div class="row q-col-gutter-xs">
        ...
        <div class="row justify-end col-12 q-pt-xs">
          <div class="row justify-end" >
            <div class="col-10 q-pt-xs">
              <q-btn-group class="InboxWorkAssignation">
                <q-btn
                  outline
                  color="red"
                  class="full-width"
                  @click="$router.push({name:'InboxWorkAssignation'})"
                  label="Cancelar">
                </q-btn>
              </q-btn-group>
  ...
  rejectForm.value.validate().then(valid => {
    if (valid) {
      ...
      DischargeImpedimentsServices.send_to_pending({
        ...
        router.push({name:'InboxWorkAssignation'});
        }
      }).catch(e => {
        $q.loading.hide();
