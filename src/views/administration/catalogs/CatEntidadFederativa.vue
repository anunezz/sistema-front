  ...
  <div>
    ...
    >
      <template v-slot:top>
        ...
        <div class="text-h6 q-ml-sm">Catálogo de Entidades</div>
      </template>
      ...
      <template v-slot:body="props">
        <q-tr :props="props" :class="[props.pageIndex % 2 != 0 ? 'bg-grey-3' : '', '']">
          <q-td>
            {{ props.row.id_entidad_federativa }}
          </q-td>
          <q-td>
            {{ props.row.entidad_federativa }}
          </q-td>
          <q-td>
        ...
        <q-card-section>
          <q-form class="validate-form" @submit="catForm.action === 1 ? onSubmit() : onUpdate()">
            <div class="row q-col-gutter-md">
              ...
              <div class="col-6">
                <q-input
                  v-model="catForm.entidad_federativa"
...
<script setup>
import useCatEntidadFederativa from 'src/composables/administration/catalogs/useCatEntidadFederativa'
const {
  title,
  showModal,
  registers,
