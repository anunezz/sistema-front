  ...
  <div>
    ...
    >
      <template v-slot:top>
        ...
        <div class="text-h6 q-ml-sm">Catálogo de Categorías</div>
      </template>
        ...
        <q-card-section>
          <q-form class="validate-form" @submit="catForm.action === 1 ? onSubmit() : onUpdate()">
            <div class="row q-col-gutter-md">
              <div class="col-6">
                <q-input
                  v-model="catForm.idalpha2"
                  label="Nombre"
                  :rules="[isRequired, hasTwoLength]"
                  clearable
                  outlined
                />
              </div>
              <div class="col-6">
                <q-input
                  v-model="catForm.idalpha3"
                  label="Nombre"
                  :rules="[isRequired, hasThreeLengths]"
                  clearable
                  outlined
                />
              </div>
...
<script setup>
import useCatPais from 'src/composables/administration/catalogs/useCatCategorias'
const {
  title,
  showModal,
  registers,
