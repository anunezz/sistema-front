  ...
  <div>
    ...
    >
      <template v-slot:top>
        ...
        <div class="text-h6 q-ml-sm">Catálogo de Municipios</div>
      </template>
            ...
            <div class="row q-col-gutter-md">
              ...
              <div class="col-6">
                <q-select
                  outlined
                  clearable
                  v-model="catForm.id_entidad_federativa"
                  :options="federalEntities"
                  :rules="[isRequired]"
                  option-value="id_entidad_federativa"
                  option-label="entidad_federativa"
...
<script setup>
import useCatMunicipio from 'src/composables/administration/catalogs/useCatMunicipio'
const {
  title,
  showModal,
  registers,
