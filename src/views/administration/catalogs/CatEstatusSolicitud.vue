  ...
  <div>
    ...
    >
      <template v-slot:top>
        ...
        <div class="text-h6 q-ml-sm">Catálogo de Estatus</div>
      </template>
      ...
      <template v-slot:body="props">
        <q-tr :props="props" :class="[props.pageIndex % 2 != 0 ? 'bg-grey-3' : '', '']">
          <q-td>
            {{ props.row.id_estatus_solicitud }}
          </q-td>
          <q-td>
            {{ props.row.estatus_solicitud }}
          </q-td>
          <q-td>
        ...
        <q-card-section>
          <q-form class="validate-form" @submit="catForm.action === 1 ? onSubmit() : onUpdate()">
            <div class="row q-col-gutter-md">
              <div class="col-12">
                <q-input
                  v-model="catForm.estatus_solicitud"
...
<script setup>
import useCatEstatusSolicitud from 'src/composables/administration/catalogs/useCatEstatusSolicitud'
