...
import CatPerfilServices from "src/services/administration/catalogs/CatPerfilServices";
...
const useCatPerfil = () => {
    ...
    const deleteRegister = (id) => {
        ...
        CatPerfilServices.remove(id).then(response => {
            $q.loading.hide()
    ...
    const getRegisters = (props) => {
        ...
        CatPerfilServices.index(data).then(response => {
            $q.loading.hide()
            if (response.data.success) {
    ...
    const onSubmit = () => {
        $q.loading.show()
        CatPerfilServices.store(catForm.value).then(response => {
