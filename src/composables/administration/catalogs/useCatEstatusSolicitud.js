...
const useCatEstatusSolicitud = () => {
    ...
    const columns = ref([
        {
            name: 'id_estatus_solicitud',
            label: 'ID',
            align: 'left',
            field: row => row.id_estatus_solicitud,
            sortable: true
        },
        {
    ...
    const deleteRegister = (id) => {
        ...
        CatEstatusSolicitudServices.remove(id).then(response => {
            $q.loading.hide()
    ...
    const getRegisters = (props) => {
        ...
        CatEstatusSolicitudServices.index(data).then(response => {
            $q.loading.hide()
            if (response.data.success) {
    ...
    const onSubmit = () => {
        $q.loading.show()
        CatEstatusSolicitudServices.store(catForm.value).then(response => {
    ...
    const onUpdate = () => {
        $q.loading.show()
        CatEstatusSolicitudServices.update(
...
export default useCatEstatusSolicitud
