<template>
	...
	>
		<q-card class="disable-user-card" style="min-height: 400px">
			<q-card-section style="background-color: #c39326" class="text-white"> </q-card-section>
...
@media (max-width: 599px) {
	/* :maximized fuerza width/height:100% en la tarjeta; sin este reset,
     min-width:800px seguiría desbordando el viewport horizontalmente en
     celular (mismo bug/fix que Users/Index.vue .user-modal-card). */
	.disable-user-card {
		min-width: auto;
		max-width: 100vw;
	}
