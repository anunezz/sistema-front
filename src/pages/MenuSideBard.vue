...
const menuList = ref([
	...
	{
		// Inicio, Productos y Administración de Catálogos se retiraron del
		// menú lateral (pedido explícito) — sus permisos/rutas/controladores
		// reales no se tocaron (catalog_management sigue vigente en backend,
		// solo deja de listarse aquí), solo dejan de aparecer como accesos.
		moduleName: '',
		childs: [
			{
				id: 2,
