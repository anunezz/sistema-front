  ...
  <q-layout view="hHh lpR fFf">
	...
	>
      ...
      <q-page class="bg-dark-page">
        ...
        <section id="servicios" class="q-pa-lg q-pa-xl-md">
          ...
          <div class="services-grid">
            ...
            <q-card class="service-card">
              ...
              <q-card-section class="text-center">
                ...
                <div class="text-body2 text-grey-4 q-mt-sm">
                  Cortes, tintes, peinados y tratamientos.
                </div>
            ...
            <q-card class="service-card">
              ...
              <q-card-section class="text-center">
                ...
                <div class="text-body2 text-grey-4 q-mt-sm">
                  Faciales, skincare y maquillaje.
                </div>
            ...
            <q-card class="service-card">
              ...
              <q-card-section class="text-center">
                ...
                <div class="text-body2 text-grey-4 q-mt-sm">
                  Bebidas energéticas y saludables.
                </div>
        ...
        <section class="q-pa-lg q-pa-xl-md">
          ...
          <div class="about-grid">
            ...
            <div>
              ...
              <div class="text-h2 text-pink-3 text-weight-bold">
                The Planet Studio
              </div>

              <div class="text-body1 text-grey-4 q-mt-lg">

                En The Planet Studio combinamos estética,
                terapias alternativas, wellness y productos
                profesionales para brindarte una experiencia
                única de relajación y belleza.
...
>
  ...
  <q-carousel-slide
    name="1"
    img-src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?q=80&w=1400&auto=format&fit=crop"
  >
  ...
  <q-carousel-slide
    name="2"
    img-src="https://images.unsplash.com/photo-1560066984-138dadb4c035?q=80&w=1400&auto=format&fit=crop"
  >
    ...
    <div class="carousel-content">
      ...
      <div class="text-subtitle1 text-white q-mt-md">
        Revitaliza tu piel con tratamientos premium.
      </div>
  ...
  >
    ...
    <div class="carousel-content">
      ...
      <div class="text-subtitle1 text-white q-mt-md">
        Terapias alternativas y relajación total.
      </div>
  ...
  <q-carousel-slide
    name="4"
    img-src="https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1400&auto=format&fit=crop"
  >
    ...
    <div class="carousel-content">
      ...
      <div class="text-subtitle1 text-white q-mt-md">
        Descubre productos profesionales para tu cuidado.
      </div>
